...
// import { IntimateWearImages } from "../../Database/ApparelDB";
...
//   const filteredImages = IntimateWearImages.filter((item) => {
//     const genderMatch =
...
//         <img
//           src="/ApparelImages/HeroImages/intimate-hero.jpg"
...
//           Discover Premium Intimate Wear Collection
//           </h1>
//           <p className="max-w-xl mb-6 text-lg sm:text-xl">
//           Confidence begins underneath. Intimatewear crafted for comfort, support, and effortless elegance.
...
//         <h1 className="mb-8 text-5xl font-semibold">Intimate Wear Collection</h1>
//         {/* Filter Buttons */}
//         <div className="mb-6">
