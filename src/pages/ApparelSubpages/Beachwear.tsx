...
import { BeachwearImages } from "../../Database/ApparelDB";
...
const Beachwear: React.FC = () => {
  ...
  const filteredImages = BeachwearImages.filter((item) => {
    const genderMatch =
  ...
  return (
    <main className="">
      ...
      <header className="relative h-[80vh] overflow-hidden bg-stone-200">
        ...
        <img
          src="/ApparelImages/HeroImages/beach-hero.jpg"
        ...
        <div className="relative z-10 flex flex-col items-start justify-center h-full px-6 font-roboto pt-[4rem] sm:pt-[8rem] pl-[2rem] sm:pl-[4rem] text-white">
          <h1 className="mb-4 text-4xl font-bold sm:text-5xl">
            Discover Premium Beachwear Collection
          </h1>
          <p className="max-w-xl mb-6 text-lg sm:text-xl">
            Made for sunshine, built for adventure. Beachwear that moves with
            every splash.
          </p>
        </div>
      </header>
      ...
      <section className="lg:p-[6rem] md:p-[4rem] sm:p-[2rem] p-[1rem]">
        <h1 className="mb-8 text-5xl font-semibold">Beachwear Collection</h1>
        {/* Filter Buttons */}
        <div className="mb-6">
