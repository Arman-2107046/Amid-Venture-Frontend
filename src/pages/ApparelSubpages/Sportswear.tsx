...
import {SportswearImages} from "../../Database/ApparelDB";
...
const Sportswear: React.FC = () => {
  ...
  const filteredImages = SportswearImages.filter((item) => {
    const genderMatch =
  ...
  return (
    <main className="">
      ...
      <header className="relative h-[80vh] overflow-hidden bg-stone-200">
        ...
        <img
          src="/ApparelImages/HeroImages/sports-hero.jpg"
        ...
        <div className="relative z-10 flex flex-col items-start justify-center h-full px-6 font-roboto pt-[4rem] sm:pt-[8rem] pl-[2rem] sm:pl-[4rem] text-white">
          ...
          Discover Premium Sportswear
          </h1>
          <p className="max-w-xl mb-6 text-lg sm:text-xl">
          Experience the perfect fusion of performance, comfort, and modern style with our premium sportswear collection.
      ...
      <section className="lg:p-[6rem] md:p-[4rem] sm:p-[2rem] p-[1rem]">
        <h1 className="mb-8 text-5xl font-semibold">Sportswear Collection</h1>
        {/* Filter Buttons */}
        <div className="mb-6">
