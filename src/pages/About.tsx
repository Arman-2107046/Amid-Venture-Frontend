    ...
    <div>
      ...
      <section className="relative w-full px-6 py-20 bg-white lg:px-20 font-dm">
        ...
        <div className="flex flex-col items-center justify-around lg:flex-row">
          ...
          {/* Right Images */}
          {/* Right Images */}
          <div className="relative w-full max-w-md lg:w-1/2 mt-[4rem]">
            {/* Bottom Image */}
            <div
              className="absolute z-0 w-3/5 h-auto overflow-hidden shadow-xl rounded-xl md:w-64 md:h-80"
            ...
            >
              <img
                ...
                className="object-cover transition-transform duration-500 ease-in-out md:h-full md:w-full hover:scale-105"
              />
            </div>

            {/* Top Image */}
            <div className="relative z-10 w-3/5 h-auto overflow-hidden shadow-2xl md:w-64 md:h-80 rounded-xl">
              <img
      ...
      <section>
  <div className="flex flex-col items-center justify-center px-4 py-12 bg-stone-100 sm:px-6 lg:px-20">
    <div className="max-w-2xl mx-auto text-center">
      <h1 className="mb-4 text-3xl font-light text-gray-800 sm:text-4xl lg:text-5xl font-dmSerifText">
        Join Us in This Momentum of Growth
      </h1>
      <p className="mb-8 text-base font-light text-gray-600 sm:text-lg lg:text-xl">
        Connect with Amid Venture to explore how our visionary approach and comprehensive expertise can elevate your endeavors. Discover a partnership built on trust, innovation, and a shared commitment to shaping a better future.
      </p>
    </div>

    <div className="flex flex-col gap-4 mb-8 sm:flex-row font-dmSerifText">
      <button
        className="px-6 py-2 font-light transition duration-300 bg-white rounded-full shadow-md text-slate-600 hover:bg-stone-50"
    ...
    <div className="flex flex-col items-center justify-center gap-4 text-sm text-center text-gray-600 sm:flex-row sm:text-base">
