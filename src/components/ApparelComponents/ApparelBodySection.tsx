...
//   {
//     title: "Intimate Wear",
//     image: "/ApparelImages/I1.jpg",
//     path: "/Intimate Wear",
//   },
//   {
//     title: "Home Textile",
//     image: "/ApparelImages/H1.jpg",
//     path: "/Home Textile",
//   },
// ];
...
//   return (
//     <>
//       <div className="grid gap-6 lg:ml-4 lg:grid-cols-4 lg:p-[6rem] md:grid-cols-3  grid-cols-1 md:p-[4rem] sm:grid-cols-2 sm:p-[2rem] ">
//         <div className="max-w-xl mb-10 text-left mt-[2rem] lg:p-[1.5rem] md:p-[1rem] sm:p-[1rem]">
//           <h1 className="mb-4 font-semibold text-gray-800 lg:text-5xl md:text-4xl sm:text-2xl">
//             Our Product Categories
//           </h1>
//           <p className="font-light text-gray-600 sm:max-w-[10rem] md:max-w-[14rem]">
...
//             <div className="relative lg:h-[25rem] lg:w-[18rem] md:h-[20rem] md:w-[14.5rem] sm:h-[18rem] sm:w-[13.5rem] h-[16rem] w-[12rem]  mb-6 overflow-hidden group cursor-pointer transition-all duration-500 ease-in-out hover:brightness-[.8] md:ml-3">
//               <img
//                 src={image}
//                 alt={title}
...
const productCategories = [
  ...
  { title: "Beachwear", image: "/ApparelImages/B1.jpg", path: "/beachwear" },
  { title: "Swimwear", image: "/ApparelImages/SM1.jpg", path: "/Swimwear" },
  { title: "Intimate Wear", image: "/ApparelImages/I1.jpg", path: "/Intimate Wear" },
  { title: "Home Textile", image: "/ApparelImages/H1.jpg", path: "/Home Textile" },
];
