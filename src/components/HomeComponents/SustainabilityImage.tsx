  ...
  return (
    <div className="flex w-full max-w-7xl mx-auto gap-6 h-[75vh] px-4">
      {sections.map((section, index) => (
        <div
          key={section.title}
          className="relative flex-1 overflow-hidden font-light rounded-lg group"
